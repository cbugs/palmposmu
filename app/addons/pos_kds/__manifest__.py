...
############################################################################
{
    'name': 'POS Kitchen Display System (KDS)',
    'version': '19.0.1.0.0',
    ...
    'data': [
        ...
        'data/kitchen_screen_demo.xml',
        "views/kitchen_screen_views.xml",
        "views/pos_order_views.xml",
        "views/product_product_views.xml",
        "views/pos_kds_menus.xml",
    ],
    'assets': {
        'point_of_sale._assets_pos': [
            # Temporarily disabled for Odoo 19 compatibility - needs rewrite
            # 'pos_kds/static/src/js/fields_load.js',
            # 'pos_kds/static/src/js/order_pay.js',
            'pos_kds/static/src/js/order_button.js',
        ],
        'web.assets_backend': [
            'pos_kds/static/src/css/kitchen_screen.css',
            'pos_kds/static/src/js/kitchen_screen.js',
            'pos_kds/static/src/xml/kitchen_screen_templates.xml',
