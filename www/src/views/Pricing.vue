...
const plans = [
  {
    ...
    features: [
      '1 POS user',
      'Unlimited products',
      'Fast and simple POS interface',
      'Print receipts',
      'Daily sales summary report',
      'Basic stock tracking',
      'Low stock alerts',
      'Mauritius VAT-ready setup',
      'Works on laptop / tablet / mobile browser',
      'Cloud backup',
      'Email support',
    ]
  },
  {
    ...
    features: [
      'Up to 5 POS users',
      'Multi-outlet support (up to 3 locations)',
  ...
  },
  {
    ...
    features: [
      ...
      'Custom reports',
      'API integrations',
      'Bank/payment integration support',
      'Role-based permissions',
      'Advanced inventory forecasting',
      'Dedicated account manager',
      'On-site training & installation',
      'Hardware & devices included (POS terminal, printer, drawer, barcode scanner, etc.)',
    ]
  },
]
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'All plans include basic setup and configuration. Custom plans include full hardware setup with terminals, printers, scanners, installation, system configuration, data migration, training sessions, and ongoing support tailored to your specific business needs.'
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes! Basic training and documentation is included with all plans. Comprehensive on-site training and installation is included with Custom plans. All plans also include access to our support resources.'
  },
]
