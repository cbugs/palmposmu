...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      'Customer loyalty & discount programs',
      'Advanced analytics & custom reports',
      'Product variants (size, color, etc.)',
      'Purchase orders & supplier management',
      'Employee shifts & permissions',
      'Gift cards & vouchers',
      'Mobile POS app (tablets)',
  ...
  },
  {
    ...
    features: [
      ...
      'Advanced manufacturing & kitting',
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'The setup fee covers initial system configuration, data migration (if needed), training sessions, and onboarding support to ensure a smooth start.'
  },
  {
